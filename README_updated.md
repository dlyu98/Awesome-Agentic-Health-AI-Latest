...
[^1]: Jinghao Feng, Qiaoyu Zheng, Chaoyi Wu, Ziheng Zhao, Ya Zhang, Yanfeng Wang & Weidi Xie, **“M³Builder: A Multi‑Agent System for Automated Machine Learning in Medical Imaging.”** arXiv:2502.20301 (2025). The paper introduces M³Builder, a multi‑agent system that automates medical‑imaging ML workflows and reports a 94.29 % task‑completion success rate【888183404684677†L53-L69】.

[^2]: Nima Fathi, Amar Kumar & Tal Arbel, **“AURA: A Multi‑Modal Medical Agent for Understanding, Reasoning & Annotation.”** arXiv:2507.16940 (2025). AURA is a visual‑linguistic explainability agent that integrates segmentation, counterfactual generation and evaluation tools for interactive medical image analysis【875702780077740†L49-L67】.

[^3]: Wenting Chen, Yi Dong, Zhaojun Ding, Yucheng Shi & colleagues, **“RadFabric: Agentic AI System with Reasoning Capability for Radiology.”** Preprint (2025). RadFabric employs multi‑agent, multimodal reasoning for chest‑x‑ray interpretation; it achieves near‑perfect detection of challenging pathologies and a diagnostic accuracy of 0.799 compared to 0.229–0.527 for traditional systems【651712218183563†L81-L87】.

[^4]: Google Research & collaborators, **“Towards accurate differential diagnosis with large language models.”** *Nature* (2025). The Articulate Medical Intelligence Explorer (AMIE) delivers a top‑10 diagnostic accuracy of 59.1 %, outperforming unassisted clinicians and improving clinician performance when used as an assistant【41675009081567†L372-L390】.

[^5]: Google Research, **“AMIE: Advancing large language models for disease management.”** Blog post (2025). AMIE’s Dialogue Agent and Management Reasoning Agent generate longitudinal management plans that match or exceed those of primary‑care physicians and improve treatment precision in randomised studies【700379143592045†L221-L255】【700379143592045†L343-L370】.

[^6]: Hippocratic AI & Universal Health Services, **“UHS launches Hippocratic AI’s generative AI voice agents.”** Press release (2025). Generative AI voice agents for post‑discharge phone calls achieve high patient satisfaction (average 9/10) and are being expanded across hospitals【212509038993599†L224-L251】.

[^7]: (Authors), **“AutoCBT: An Autonomous Cognitive Behavioral Therapy Agent.”** arXiv preprint (2025). AutoCBT introduces dynamic routing and supervisory mechanisms inspired by real counselling, leading to more helpful and contextually appropriate CBT responses【310586166793977†L53-L70】.

[^8]: Google Research, **“Personal Health Agent: A multi‑agent system for personalised health insights.”** Blog post (2025). The PHA uses data‑science, domain‑expert and health‑coach agents; evaluations show improved analysis‑plan quality and personalised responses【623711362828657†L246-L260】【623711362828657†L306-L354】.

[^9]: Google Research, **“Wayfinding AI: Clarifying questions for navigating health information.”** Blog post (2025). Wayfinding AI asks clarifying questions and outperforms baseline models in user studies across helpfulness, relevance and engagement【475443089103642†L326-L365】.

[^10]: Salman Jan, Toqeer Ali Syed, Mohammad Riyaz Belgaum & colleagues, **“Agentic AI Framework for Individuals with Disabilities and Neurodivergence: A Multi‑Agent System for Healthy Eating, Daily Routines, and Inclusive Well‑Being.”** arXiv:2511.22737 (2025). The framework coordinates meal‑planner, reminder, food‑guidance and monitoring agents via a hybrid reasoning engine; evaluations show improved adherence, responsiveness and user satisfaction【539836909864261†L831-L857】.

[^11]: Chen Zhu & collaborators, **“MedAgentGym: A Scalable Interactive Training Environment for Code‑Centric Biomedical Reasoning.”** arXiv preprint (2025). MedAgentGym provides 72,413 tasks across 129 categories and interactive feedback; reinforcement learning with this environment improves LLM performance【404970063240360†L54-L69】.

[^12]: Google Research & Included Health, **“Nationwide randomised study of AI in virtual care.”** Blog post (2026). A large randomised controlled trial will evaluate conversational AI for clinical reasoning, personalised insights and navigation in virtual care【891254307725479†L219-L257】【891254307725479†L281-L287】.

[^13]: Alon Gorenshtein, Mahmud Omar, Benjamin Glicksberg & Eyal Klang, **“AI Agents in Clinical Medicine: A Systematic Review.”** (2025). The review observes that multi‑agent, retrieval‑augmented and uncertainty‑aware systems can reduce hallucination rates and improve accuracy, yet they remain computationally demanding; adoption of LLMs for imaging has increased from ≈30 % in 2020 to over 75 % in 2024, while hallucination rates of 8–15 % persist【611328004656680†L182-L197】【611328004656680†L205-L217】.

[^14]: (Authors), **“Agentic AI in Radiology: From Passive Tools to Autonomous Assistants.”** (2025). This commentary highlights the transition to dynamic triaging, context‑aware reasoning and workflow management, while noting limited clinical validation and evolving regulatory frameworks【718437852469727†L138-L151】【718437852469727†L225-L256】.